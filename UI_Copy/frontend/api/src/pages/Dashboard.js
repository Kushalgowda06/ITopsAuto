          ...
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center space-x-4 flex-1 min-w-0">
              ...
              <div className="flex-1 min-w-0">
                  ...
                  <span className="block sm:inline">COGNIZANT</span>
        ...
        <div className="max-w-7xl mx-auto relative z-10">
          ...
          >
            ...
            >
              ...
              <span className="text-white text-6xl md:text-8xl lg:text-7xl  text-transparent block text-center">
                Autonomous ITOps Toolkit
              </span>
            </motion.h2>
            <motion.p 
              className="text-xl md:text-2xl text-gray-300 mx-auto leading-relaxed"
              ...
              >
                <Link to={card.path}>
                    ...
                    <div className="relative z-10 text-center">
                        ...
                        <motion.p 
                          className="text-gray-300 group-hover:text-gray-200 mb-6 leading-relaxed text-sm text-center transition-all duration-500"
                          initial={{ opacity: 0, y: 20 }}
                          animate={{ opacity: 1, y: 0 }}
