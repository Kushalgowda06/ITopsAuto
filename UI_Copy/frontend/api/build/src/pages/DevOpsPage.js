...
const DevOpsPage = () => {
  ...
  // DevOps & IAC specific bots
  const devOpsBots = [
    {
      id: 'build-automate',
      name: 'Build Automate',
      description: 'Automates build processes, manages CI/CD pipelines, and optimizes deployment workflows with intelligent automation.',
      avatar: '🛠️',
      gradient: 'from-neon-blue to-royal-500',
      capabilities: [
        'Automated Build Processes',
        'AI Infused Infra Builds', 
    ...
    },
    {
      ...
      description: 'Designs and optimizes DevOps pipelines, infrastructure as code, and deployment strategies for maximum efficiency.',
      avatar: '⚙️',
      gradient: 'from-neon-blue to-royal-500',
      capabilities: [
        ...
        <div className="max-w-7xl mx-auto px-6 py-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-4">
              ...
              <div className="flex items-center space-x-3">
                <div className="w-12 h-12 bg-gradient-to-br from-neon-blue to-royal-500 rounded-xl flex items-center justify-center">
                  <CommandLineIcon className="w-6 h-6 text-white" />
                </div>
                <div>
                  <h1 className="text-xl font-medium">DevOps & IAC</h1>
                  <p className="text-sm text-gray-400">Infrastructure & Automation AI</p>
                </div>
              </div>
            </div>
      ...
      <section className="py-16 px-6 relative overflow-hidden">
        ...
        <div className="absolute inset-0">
          ...
          <div className="absolute inset-0">
            {[...Array(15)].map((_, i) => (
              <motion.div
                key={i}
                className="absolute text-neon-blue/20 text-2xl font-mono"
                animate={{
        ...
        <div className="max-w-full mx-auto relative z-10 px-6">
          ...
          >
            ...
            >
              Intelligent automation for your infrastructure, deployments, and operational workflows powered by advanced AI
            </motion.p>
            <motion.div
            ...
            >
              ...
              <span className="text-lg font-medium">Choose your DevOps AI specialist</span>
              <motion.div
          ...
          >
            ...
            >
              ...
              >
                <CloudIcon className="w-12 h-12 text-neon-blue mx-auto mb-4 group-hover:text-white transition-colors" />
              </motion.div>
              <h3 className="text-lg font-medium mb-2 group-hover:gradient-text transition-all duration-300">Infrastructure as Code</h3>
              <p className="text-gray-400 group-hover:text-gray-300 transition-colors">AI-powered Terraform and CloudFormation template generation</p>
            </motion.div>
            ...
            >
              ...
              >
                <CommandLineIcon className="w-12 h-12 text-neon-purple mx-auto mb-4 group-hover:text-white transition-colors" />
              </motion.div>
              <h3 className="text-lg font-medium mb-2 group-hover:gradient-text transition-all duration-300">CI/CD Automation</h3>
              <p className="text-gray-400 group-hover:text-gray-300 transition-colors">Intelligent build, test, and deployment pipeline optimization</p>
            </motion.div>
            ...
            >
              ...
              >
                <ServerIcon className="w-12 h-12 text-neon-green mx-auto mb-4 group-hover:text-white transition-colors" />
              </motion.div>
              <h3 className="text-lg font-medium mb-2 group-hover:gradient-text transition-all duration-300">Performance Monitoring</h3>
              <p className="text-gray-400 group-hover:text-gray-300 transition-colors">Real-time system monitoring and intelligent optimization</p>
            </motion.div>
          </motion.div>
        </div>
      </section>
