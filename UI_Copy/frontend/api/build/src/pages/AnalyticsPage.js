        ...
        <div className="max-w-full mx-auto relative z-10 px-6">
          ...
          >
            ...
            >
              ...
              <p className="text-gray-400 group-hover:text-gray-300 transition-colors">Interactive dashboards and advanced analytics visualization</p>
            </motion.div>
            ...
            >
              ...
              <p className="text-gray-400 group-hover:text-gray-300 transition-colors">Predictive models and AI-driven intelligent insights</p>
            </motion.div>
            ...
            >
              ...
              <p className="text-gray-400 group-hover:text-gray-300 transition-colors">Strategic insights and data-driven decision making</p>
            </motion.div>
          </motion.div>
        </div>
      </section>
