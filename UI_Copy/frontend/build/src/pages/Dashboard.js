  ...
  const dashboardCards = [
    {
      ...
      path: '/devops',
      features: ['Infrastructure as Code', 'CI/CD Management', 'Container Orchestration', 'Monitoring & Alerts'],
      bgPattern: 'terminal'
    },
    {
      id: 'analytics',
      ...
      path: '/analytics',
      features: ['Data Visualization', 'Predictive Analytics', 'ML Operations', 'Business Intelligence'],
      bgPattern: 'chart'
    },
    {
      id: 'worknext',
      ...
      path: '/worknext',
      features: ['Task Automation', 'Team Collaboration', 'Document Management', 'Meeting Intelligence'],
      bgPattern: 'productivity'
    },
    {
      id: 'itops',
      title: 'ITOps',
      description: 'Intelligent IT operations with automated incident response',
      icon: ShieldCheckIcon,
      gradient: 'from-neon-green to-royal-800',
      path: '/itops',
      features: ['Incident Management', 'Security Monitoring', 'Performance Optimization', 'Compliance Tracking'],
      bgPattern: 'security'
    }
  ];
          ...
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center space-x-4 flex-1 min-w-0">
              ...
              <div className="flex-1 min-w-0">
                                  <h1 className="text-base sm:text-lg lg:text-xl xl:text-2xl font-bold gradient-text tracking-wide leading-tight">
                  <span className="block sm:inline">COGNIZANT AUTONOMOUS</span>
                  <span className="block sm:inline sm:ml-2">IT OPERATIONS</span>
                  <span className="block sm:inline sm:ml-2">TOOLKIT</span>
                </h1>
              </div>
            </div>
      ...
      <section className="py-16 px-6 relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto relative z-10">
          ...
          >
            ...
            >
              <span className="block mb-2 text-white">Transform Your Business with</span>
              <span className="gradient-text text-6xl md:text-8xl lg:text-9xl font-black bg-gradient-to-r from-neon-blue via-neon-purple to-neon-pink bg-clip-text text-transparent animate-pulse">
            ...
            >
              ...
              <span className="text-lg font-medium">Choose your AI-powered solution</span>
              <motion.div
          ...
          <div className="relative w-full">
            <motion.div
              ...
              className="grid grid-cols-1 lg:grid-cols-4 gap-6 max-w-7xl mx-auto px-4"
            >
            {dashboardCards.map((card, index) => (
              ...
              >
                <Link to={card.path}>
                    <motion.div 
                      className="glass-card p-6 h-full relative overflow-hidden transition-all duration-300 group-hover:neon-glow preserve-3d"
                      whileHover={{ rotateX: 5 }}
                    >
                      {/* Enhanced Background Pattern */}
                      <motion.div 
                        className={`absolute inset-0 bg-gradient-to-br ${card.gradient} opacity-0 group-hover:opacity-15 transition-all duration-500`}
                        initial={{ scale: 0.8 }}
                    ...
                    <div className="absolute inset-0 opacity-0 group-hover:opacity-100 transition-opacity duration-300">
                      ...
                      <motion.div 
                        ...
                        whileHover={{ scale: 1 }}
                      >
                        <div className={`absolute inset-0 rounded-xl bg-gradient-to-r ${card.gradient} p-[2px]`}>
                    ...
                    <div className="flex items-start justify-between mb-6 relative z-10">
                        <motion.div 
                          className={`w-16 h-16 bg-gradient-to-br ${card.gradient} rounded-2xl flex items-center justify-center transition-all duration-300`}
                        ...
                        >
                        <ArrowRightIcon className="w-6 h-6 text-neon-blue" />
                        </motion.div>
                    </div>
                    ...
                    <div className="relative z-10">
                        <motion.h3 
                          className="text-xl font-medium mb-3 text-white group-hover:gradient-text transition-all duration-300"
                          initial={{ opacity: 0, y: 20 }}
                          animate={{ opacity: 1, y: 0 }}
                        ...
                        <motion.p 
                          className="text-gray-300 mb-5 leading-relaxed text-sm"
                          initial={{ opacity: 0, y: 20 }}
                          animate={{ opacity: 1, y: 0 }}
                      ...
                      <div className="space-y-2 mb-6">
                          ...
                          <motion.div
                            key={idx}
                              ...
                              className="flex items-center space-x-2 text-xs group cursor-pointer"
                            >
                              <motion.div 
                                className={`w-1.5 h-1.5 rounded-full bg-gradient-to-r ${card.gradient}`}
                                animate={{
                                  scale: [1, 1.3, 1],
                                  opacity: [0.7, 1, 0.7],
                                }}
                        ...
                        >
                          ...
                          <motion.div 
                            className="flex items-center space-x-1 text-neon-blue group-hover:text-white transition-colors"
                      ...
                      <motion.div 
                        className="absolute top-4 right-4 w-3 h-3 bg-neon-blue rounded-full opacity-0 group-hover:opacity-80 transition-opacity duration-300"
                        animate={{ 
                          scale: [1, 1.4, 1],
                          rotate: [0, 180, 360],
                        }}
                      ...
                      />
                      <motion.div 
                        className="absolute bottom-4 left-4 w-2 h-2 bg-neon-purple rounded-full opacity-0 group-hover:opacity-60 transition-opacity duration-300"
                        animate={{ 
                          scale: [1, 1.5, 1],
                          y: [0, -5, 0],
                        }}
                      ...
                      <motion.div
                        className={`absolute top-3 left-3 w-6 h-6 rounded-full bg-gradient-to-r ${card.gradient} flex items-center justify-center text-white text-xs font-bold opacity-80`}
                        initial={{ scale: 0, rotate: -180 }}
                        animate={{ scale: 1, rotate: 0 }}
                        transition={{ 
                          delay: 0.6 + 0.1 * index,
      ...
      <footer className="py-8 px-6 border-t border-gray-800">
        <div className="max-w-7xl mx-auto text-center">
          <p className="text-gray-400 text-sm">
                            Cognizant Autonomous IT Operations Toolkit - Powered by next-generation artificial intelligence
          </p>
        </div>
      </footer>
    </motion.div>
