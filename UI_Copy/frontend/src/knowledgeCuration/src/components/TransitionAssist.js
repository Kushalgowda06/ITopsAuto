      ...
      <Row className="theme-mb-lg">
        ...
        <Col lg={8} className="mb-3">
          <div className="theme-card" style={{ height: '600px', display: 'flex', flexDirection: 'column' }}>
            ...
            {/* Participants */}
            <div style={{ padding: '0.5rem 1rem', borderBottom: '1px solid var(--gray-200)', background: 'var(--bg-secondary)', flexShrink: 0 }}>
              <div className="d-flex gap-2">
                {currentCall.participants.map((participant, index) => (
                  <div key={index} className="d-flex align-items-center gap-2" style={{ fontSize: '0.8rem' }}>
                    ...
                    <span style={{ fontWeight: '500', color: 'var(--text-primary)' }}>{participant.name}</span>
                    <span style={{ color: 'var(--text-secondary)', fontSize: '0.75rem' }}>({participant.role})</span>
                  </div>
                ))}
              </div>
            </div>
                  ...
                  <div key={message.id} className="message-item" style={{ 
                    ...
                    <div style={{ flex: 1 }}>
                      <div className="d-flex align-items-center gap-2 mb-1">
                        <span style={{ fontWeight: '600', fontSize: '0.9rem', color: 'var(--text-primary)' }}>{message.sender}</span>
                        <span style={{ fontSize: '0.75rem', color: 'var(--text-secondary)' }}>{message.time}</span>
                      </div>
                      <div style={{ 
                ...
                <div className="d-flex gap-2">
                  {selectedCall.participants.map((participant, index) => (
                    <div key={index} className="d-flex align-items-center gap-2" style={{ fontSize: '0.85rem' }}>
                      ...
                      <span style={{ color: 'var(--text-primary)' }}>{participant.name} ({participant.role})</span>
                    </div>
                  ))}
                </div>
              </div>
      ...
      <Modal show={showJoinCallModal} onHide={() => setShowJoinCallModal(false)} size="lg" centered>
        ...
        <Modal.Body>
          <div className="meeting-details">
            ...
            <div className="mb-4">
              <h6 style={{ fontSize: '1rem', fontWeight: '600', marginBottom: '0.75rem', color: 'var(--text-primary)' }}>
              ...
              <div style={{ 
                ...
                <Form.Group className="mb-3">
                  ...
                  <Form.Control
                    type="text"
                    value="http://teams.microsoft.com/l/meetup-join/19%3ameeting_NjY4ZTM5NzAtODYwMS00ZTI0LWFjOTgtZmE1Y2Y5MjM2YjI4%40thread.v2/0?context=%7b%22Tid%22%3a%22abc123%22%2c%22Oid%22%3a%22def456%22%7d"
                    readOnly
                ...
                <div className="d-flex gap-2">
                  <Button 
                    ...
                    onClick={() => window.open('http://teams.microsoft.com/l/meetup-join/19%3ameeting_NjY4ZTM5NzAtODYwMS00ZTI0LWFjOTgtZmE1Y2Y5MjM2YjI4%40thread.v2/0?context=%7b%22Tid%22%3a%22abc123%22%2c%22Oid%22%3a%22def456%22%7d', '_blank')}
                  >
                    <HiVideoCamera style={{ marginRight: '0.3rem' }} />
                    Open Teams
                  </Button>
                  <Button 
                    ...
                    onClick={() => {
                      navigator.clipboard.writeText('http://teams.microsoft.com/l/meetup-join/19%3ameeting_NjY4ZTM5NzAtODYwMS00ZTI0LWFjOTgtZmE1Y2Y5MjM2YjI4%40thread.v2/0?context=%7b%22Tid%22%3a%22abc123%22%2c%22Oid%22%3a%22def456%22%7d');
                    }}
                  >
        ...
        <Modal.Footer>
          ...
          <Button 
            variant="primary"
            onClick={() => {
              window.open('http://teams.microsoft.com/l/meetup-join/19%3ameeting_NjY4ZTM5NzAtODYwMS00ZTI0LWFjOTgtZmE1Y2Y5MjM2YjI4%40thread.v2/0?context=%7b%22Tid%22%3a%22abc123%22%2c%22Oid%22%3a%22def456%22%7d', '_blank');
