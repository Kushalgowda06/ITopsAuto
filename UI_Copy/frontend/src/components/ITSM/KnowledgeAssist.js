            ...
            {Object.entries(content).map(([key, value]) => (
              <div key={key} className="mb-3 last:mb-0">
                ...
                <div className="pl-3 border-l border-white/20">
                  {typeof value === 'string' ? (
                    <div className="whitespace-pre-wrap text-white">{value}</div>
        ...
        {loading ? (
          <div className="flex items-center justify-center h-full">
            <div className="flex flex-col items-center space-y-4">
              ...
              <p className="text-white text-base">Loading knowledge assistance...</p>
            </div>
          </div>
        ) : content ? (
          <div>
                ...
                {alertsLoading ? (
                  <div className="flex items-center justify-center py-8">
                    <div className="flex flex-col items-center space-y-2">
                      ...
                      <p className="text-white text-sm">Loading alerts...</p>
                    </div>
                  </div>
                ) : alertsError ? (
