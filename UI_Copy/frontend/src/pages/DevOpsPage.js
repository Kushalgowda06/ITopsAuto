        ...
        <div className="max-w-full mx-auto relative z-10 px-6">
          ...
          >
            ...
            >
              ...
              <p className="text-gray-400 group-hover:text-white transition-colors">AI-powered Terraform and CloudFormation template generation</p>
            </motion.div>
            ...
            >
              ...
              <p className="text-gray-400 group-hover:text-white transition-colors">Intelligent build, test, and deployment pipeline optimization</p>
            </motion.div>
            ...
            >
              ...
              <p className="text-gray-400 group-hover:text-white transition-colors">Real-time system monitoring and intelligent optimization</p>
            </motion.div>
          </motion.div>
        </div>
      </section>
