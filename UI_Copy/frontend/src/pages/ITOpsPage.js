        ...
        <div className="max-w-full mx-auto relative z-10 px-6">
            ...
            >
              {itOpsBots.map((bot, index) => (
                ...
                to={
                  ...
                  bot.id === 'knowledge-assist' ? '/knowledge-assist' :
                  `/chat/${bot.id}`
                }
          ...
          >
            ...
            >
              ...
              <p className="text-gray-400 group-hover:text-white transition-colors">Automated incident detection and intelligent resolution</p>
            </motion.div>
            ...
            >
              ...
              <p className="text-gray-400 group-hover:text-white transition-colors">Real-time threat detection and advanced prevention</p>
            </motion.div>
            ...
            >
              ...
              <p className="text-gray-400 group-hover:text-white transition-colors">Intelligent change planning and risk assessment</p>
            </motion.div>
          </motion.div>
        </div>
      </section>
