        ...
        <div className="max-w-full mx-auto relative z-10 px-6">
          ...
          >
            ...
            >
              ...
              <p className="text-gray-400 group-hover:text-white transition-colors">Enhanced teamwork and intelligent communication tools</p>
            </motion.div>
            ...
            >
              ...
              <p className="text-gray-400 group-hover:text-white transition-colors">Smart document processing and automated analysis</p>
            </motion.div>
            ...
            >
              ...
              <p className="text-gray-400 group-hover:text-white transition-colors">Hands-free voice commands and speech recognition</p>
            </motion.div>
          </motion.div>
        </div>
      </section>
