    ...
    <div ref={containerRef} className="min-h-screen bg-gradient-to-br from-light-900 via-light-800 to-light-900 text-white overflow-hidden">
      ...
      >
        ...
        >
          <div className="max-w-full mx-auto flex justify-between items-center px-6">
            ...
            <div className="flex items-center space-x-4">
              ...
              <div>
                <h1 className="text-base sm:text-lg lg:text-xl xl:text-2xl font-bold text-white tracking-wide leading-tight whitespace-nowrap">
                  AUTONOMOUS IT OPERATIONS TOOLKIT
                </h1>
              </div>
            </div>
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-6">
          ...
          >
            {/* <div className="glass-card p-8 font-mono text-left  w-full border border-neon-blue/30 shadow-2xl">
              <div className="flex items-center mb-6">
                ...
                <div className="ml-4 text-white text-sm font-semibold">  Autonomous IT Operations Toolkit Terminal</div>
          ...
          >
            ...
            <p className="text-2xl md:text-4xl text-gray-200 mx-auto leading-relaxed mb-8 font-medium">
              Where <span className="text-neon-blue font-bold">IT Operations</span> Meet Intelligence
            </p>
            <p className="text-xl md:text-2xl text-white mx-auto leading-relaxed">
              Enable autonomous service management, predictive insights, and self-healing infrastructure with Agentic AI
            </p>
          </motion.div>
          ...
          <motion.div
            ...
            animate={{ opacity: 1, y: 0 }}
            transition={{ duration: 1, delay: 2 }}
            className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-12 mx-auto"
          >
            <div className="glass-card p-8 text-center hover:scale-105 transition-transform duration-300">
              ...
              <div className="text-white text-lg">Reduced Complexity</div>
            </div>
            <div className="glass-card p-8 text-center hover:scale-105 transition-transform duration-300">
              <div className="text-4xl font-bold text-neon-green mb-3">3x</div>
              <div className="text-white text-lg">Faster Delivery</div>
            </div>
            <div className="glass-card p-8 text-center hover:scale-105 transition-transform duration-300">
              <div className="text-4xl font-bold text-neon-purple mb-3">24/7</div>
              <div className="text-white text-lg">AI Monitoring</div>
            </div>
          </motion.div>
        ...
        <div className="max-w-full mx-auto px-6">
          ...
          >
            <h2 className="text-xl sm:text-2xl md:text-3xl lg:text-4xl font-medium mb-6 px-6 leading-relaxed break-words text-center">
              ...
              <span className="block">  Autonomous IT Operations Toolkit?</span>
            </h2>
      ...
      <section className="py-20 px-6">
        <div className=" mx-auto text-center">
          ...
          >
            ...
            <p className="text-xl text-white mb-8 mx-auto">
      ...
      <footer className="py-8 px-6 border-t border-gray-800">
        <div className="max-w-full mx-auto text-center px-4">
          ...
          <p className="text-gray-400">© 2024   Autonomous IT Operations Toolkit. All rights reserved.</p>
        </div>
      </footer>
          ...
          >
                ...
                <div className="flex items-center justify-center h-full bg-gradient-to-br from-royal-900 to-royal-700 text-white">
                  <div className="text-center">
                    ...
                    <p className="text-white mb-4">
                      Experience the power of   Autonomous IT Operations Toolkit
                    </p>
            ...
            <div className="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-black/80 to-transparent p-6">
              <h3 className="text-xl font-bold text-white mb-2">
                  Autonomous IT Operations Toolkit Demo
              </h3>
