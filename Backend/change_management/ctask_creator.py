...
class ServiceNowChangeRequests:
    def __init__(self):
        ...
        # Initiate vault using environment variable
    ...
    def get_response_vector_db(self, curr_chg):
        ...
        quest += "Implementation Plan : \n" + curr_chg[0]['implementation_plan'] + '\n'
        ...
        for ctask_data in ctask_json:
            ctask = curr_chg_obj.create_task(
                short_description=ctask_data['short_description'],
                number=change_number.upper(),
                sys_id=curr_chg[0]['sys_id'],
                description=ctask_data['description'],
                assignment_group=ctask_data['assignment_group']
            )
