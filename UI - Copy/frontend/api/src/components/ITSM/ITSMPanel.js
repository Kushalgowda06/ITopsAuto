          ...
          <button
            ...
            className={`px-3 py-1.5 rounded-md text-xs font-medium transition-all duration-200 ${
              currentFilter === "incident"
                ...
                : "bg-dark-700/50 text-gray-300 hover:bg-dark-700 hover:text-white"
            }`}
          >
            Incident
          </button>
              ...
              >
                <div className="flex justify-between items-center mb-2">
                  ...
                  <span className="text-sm">
                    <strong className="font-semibold text-gray-300">State</strong> - <span className="text-gray-400">{ticket.state}</span>
                  </span>
                </div>
                <p className="mb-2 text-sm">
                  <span>
                    <strong className="font-semibold text-gray-300">Short Description:</strong>
                  </span>
                  <span 
                ...
                <div className="flex justify-between items-center text-sm">
                  <span>
                    <strong className="font-semibold text-gray-300">Priority</strong> - <span className="text-gray-400">{ticket.priority}</span>
                  </span>
                  <span>
                    <strong className="font-semibold text-gray-300">Assigned to</strong> - <span className="text-gray-400">{ticket.assigned_to}</span>
                  </span>
                </div>
              </div>
            ))
