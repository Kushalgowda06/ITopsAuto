              ...
              {filteredMeetings.map((meeting) => (
                ...
                onMouseLeave={(e) => {
                  ...
                  <div className="d-flex justify-content-between align-items-start mb-2">
                    <div style={{ flex: 1 }}>
                      <h6 style={{ fontSize: '1rem', fontWeight: '600', marginBottom: '0.25rem', color: '#333' }}>
                        {meeting.title}
                      </h6>
                      ...
                      <div className="d-flex align-items-center gap-3 mb-2" style={{ fontSize: '0.85rem', color: '#666' }}>
                      ...
                      <div className="d-flex align-items-center gap-2" style={{ fontSize: '0.8rem', color: '#666' }}>
            ...
            <div className="theme-card-body" style={{ padding: '1rem', flex: 1, overflow: 'auto' }}>
              {meetingRooms.map((room) => (
                <div key={room.id} className="room-item" style={{ 
                  ...
                  background: room.availability === 'Available' ? '#e8f5e8' : '#ffe6e6',
                  borderRadius: '6px',
                  border: `1px solid ${room.availability === 'Available' ? '#c8e6c9' : '#ffcccb'}`,
                  cursor: 'pointer'
                }}
